...
```text
Cloud Security     →  AWS · Azure · IAM hardening · threat modeling
System Security    →  OS hardening · secure configurations · auditing  
Containerization   →  Kubernetes · Proxmox · KVM · virtualization
```
